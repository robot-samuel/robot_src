...
class ErrorMessage : public ::google::protobuf::Message {
 public:
  ...
  // optional bool xrs2015_driverNodeOFF = 14;
  inline bool has_xrs2015_drivernodeoff() const;
  inline void clear_xrs2015_drivernodeoff();
  static const int kXrs2015DriverNodeOFFFieldNumber = 14;
  inline bool xrs2015_drivernodeoff() const;
  inline void set_xrs2015_drivernodeoff(bool value);
 ...
 private:
  ...
  inline void set_has_xrs2015_drivernodeoff();
  inline void clear_has_xrs2015_drivernodeoff();
...
// optional bool xrs2015_driverNodeOFF = 14;
inline bool ErrorMessage::has_xrs2015_drivernodeoff() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void ErrorMessage::set_has_xrs2015_drivernodeoff() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ErrorMessage::clear_has_xrs2015_drivernodeoff() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void ErrorMessage::clear_xrs2015_drivernodeoff() {
  xrs2015_drivernodeoff_ = false;
  clear_has_xrs2015_drivernodeoff();
}
