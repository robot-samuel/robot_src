...
void protobuf_AssignDesc_ErrorMessage_2eproto() {
  ...
  static const int ErrorMessage_offsets_[14] = {
...
void protobuf_AddDesc_ErrorMessage_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "r\030\r \001(\010\022\035\n\025xrs2015_driverNodeOFF\030\016 \001(\010", 438);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 13: {
        ...
        if (input->ExpectTag(112)) goto parse_xrs2015_driverNodeOFF;
        break;
      }
...
void ErrorMessage::MergeFrom(const ErrorMessage& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_xrs2015_drivernodeoff()) {
...
void ErrorMessage::Swap(ErrorMessage* other) {
  if (other != this) {
    ...
    std::swap(xrs2015_drivernodeoff_, other->xrs2015_drivernodeoff_);
