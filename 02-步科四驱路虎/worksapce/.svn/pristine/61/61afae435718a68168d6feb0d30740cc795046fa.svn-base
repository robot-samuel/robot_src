...
#define RECV_WAITE_TIME 30
#define RECV_DATA_SIZE 1
#define  RECV_NO_COUNTER 1
...
public:
   ...
   kincocanfd133Mode();
   kincocanfd133Mode(std::string port,int devadd,int dir);
	...
	void StatusRecord( boost::shared_ptr<socketcan> &vecpa);
...
private:
	std::string ttyport;
	kincors232Fd133Driver  Fd133Driver;
	int  add;
