...
{
  assert(message->base.descriptor == &extern_sensor__descriptor);
...
{
  {
    ...
    offsetof(ExternSensor__ModeTempHumi, has_interior_temp),
    offsetof(ExternSensor__ModeTempHumi, interior_temp),
    NULL,
    NULL,
    0,             /* flags */
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModeTempHumi, has_interior_humi),
    offsetof(ExternSensor__ModeTempHumi, interior_humi),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModeFan, has_fan_id),
    offsetof(ExternSensor__ModeFan, fan_id),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModeFan, has_fan_mode),
    offsetof(ExternSensor__ModeFan, fan_mode),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModeFan, has_fan_status),
    offsetof(ExternSensor__ModeFan, fan_status),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModeFan, has_vaule_open),
    offsetof(ExternSensor__ModeFan, vaule_open),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModeFan, has_vaule_close),
    offsetof(ExternSensor__ModeFan, vaule_close),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModePX24ES, has_out1),
    offsetof(ExternSensor__ModePX24ES, out1),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModePX24ES, has_out2),
    offsetof(ExternSensor__ModePX24ES, out2),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor__ModePX24ES, has_extraneouslight_out),
    offsetof(ExternSensor__ModePX24ES, extraneouslight_out),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor, n_temp_pt100),
    offsetof(ExternSensor, temp_pt100),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    offsetof(ExternSensor, n_temp_humi),
    offsetof(ExternSensor, temp_humi),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    offsetof(ExternSensor, n_fan_msg),
    offsetof(ExternSensor, fan_msg),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor, n_io_infrared),
    offsetof(ExternSensor, io_infrared),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor, n_io_collision),
    offsetof(ExternSensor, io_collision),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(ExternSensor, led_status),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(ExternSensor, has_online),
    offsetof(ExternSensor, online),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
