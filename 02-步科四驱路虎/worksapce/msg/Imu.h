// Generated by gencpp from file dgvmsg/Imu.msg
// DO NOT EDIT!


#ifndef DGVMSG_MESSAGE_IMU_H
#define DGVMSG_MESSAGE_IMU_H
...
struct Imu_
{
  ...
  typedef boost::shared_ptr< ::dgvmsg::Imu_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dgvmsg::Imu_<ContainerAllocator> const> ConstPtr;

}; // struct Imu_

typedef ::dgvmsg::Imu_<std::allocator<void> > Imu;

typedef boost::shared_ptr< ::dgvmsg::Imu > ImuPtr;
typedef boost::shared_ptr< ::dgvmsg::Imu const> ImuConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dgvmsg::Imu_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dgvmsg::Imu_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dgvmsg::Imu_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dgvmsg::Imu_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dgvmsg::Imu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dgvmsg::Imu_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dgvmsg::Imu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dgvmsg::Imu_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dgvmsg::Imu_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dgvmsg::Imu_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6a62c6daae103f4fULL;
  static const uint64_t static_value2 = 0xf57a132d6f95cec2ULL;
};

template<class ContainerAllocator>
struct DataType< ::dgvmsg::Imu_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dgvmsg/Imu";
...
template<class ContainerAllocator>
struct Definition< ::dgvmsg::Imu_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dgvmsg::Imu_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dgvmsg::Imu_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dgvmsg::Imu_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
