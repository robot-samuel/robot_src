// Generated by gencpp from file dgvmsg/LaserScan.msg
// DO NOT EDIT!


#ifndef DGVMSG_MESSAGE_LASERSCAN_H
#define DGVMSG_MESSAGE_LASERSCAN_H
...
struct LaserScan_
{
  ...
  typedef boost::shared_ptr< ::dgvmsg::LaserScan_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dgvmsg::LaserScan_<ContainerAllocator> const> ConstPtr;

}; // struct LaserScan_

typedef ::dgvmsg::LaserScan_<std::allocator<void> > LaserScan;

typedef boost::shared_ptr< ::dgvmsg::LaserScan > LaserScanPtr;
typedef boost::shared_ptr< ::dgvmsg::LaserScan const> LaserScanConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dgvmsg::LaserScan_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dgvmsg::LaserScan_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dgvmsg::LaserScan_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dgvmsg::LaserScan_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dgvmsg::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dgvmsg::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dgvmsg::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dgvmsg::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dgvmsg::LaserScan_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dgvmsg::LaserScan_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x90c7ef2dc6895d81ULL;
  static const uint64_t static_value2 = 0x024acba2ac42f369ULL;
};

template<class ContainerAllocator>
struct DataType< ::dgvmsg::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dgvmsg/LaserScan";
  }
...
template<class ContainerAllocator>
struct Definition< ::dgvmsg::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dgvmsg::LaserScan_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dgvmsg::LaserScan_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dgvmsg::LaserScan_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DGVMSG_MESSAGE_LASERSCAN_H
