...
class ControllerMessage : public ::google::protobuf::Message {
 public:
  ...
  // optional .ControllerMessage.Dirver DirverMessage = 2;
  inline bool has_dirvermessage() const;
  inline void clear_dirvermessage();
  static const int kDirverMessageFieldNumber = 2;
  inline const ::ControllerMessage_Dirver& dirvermessage() const;
  inline ::ControllerMessage_Dirver* mutable_dirvermessage();
  inline ::ControllerMessage_Dirver* release_dirvermessage();
  inline void set_allocated_dirvermessage(::ControllerMessage_Dirver* dirvermessage);
 ...
 private:
  ...
  inline void set_has_dirvermessage();
  inline void clear_has_dirvermessage();
  ...
  ::ControllerMessage_Dirver* dirvermessage_;
...
// optional .ControllerMessage.Dirver DirverMessage = 2;
inline bool ControllerMessage::has_dirvermessage() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ControllerMessage::set_has_dirvermessage() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ControllerMessage::clear_has_dirvermessage() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ControllerMessage::clear_dirvermessage() {
  if (dirvermessage_ != NULL) dirvermessage_->::ControllerMessage_Dirver::Clear();
  clear_has_dirvermessage();
}
inline const ::ControllerMessage_Dirver& ControllerMessage::dirvermessage() const {
  return dirvermessage_ != NULL ? *dirvermessage_ : *default_instance_->dirvermessage_;
}
inline ::ControllerMessage_Dirver* ControllerMessage::mutable_dirvermessage() {
  set_has_dirvermessage();
  if (dirvermessage_ == NULL) dirvermessage_ = new ::ControllerMessage_Dirver;
  return dirvermessage_;
}
inline ::ControllerMessage_Dirver* ControllerMessage::release_dirvermessage() {
  clear_has_dirvermessage();
  ::ControllerMessage_Dirver* temp = dirvermessage_;
  dirvermessage_ = NULL;
  return temp;
}
inline void ControllerMessage::set_allocated_dirvermessage(::ControllerMessage_Dirver* dirvermessage) {
  delete dirvermessage_;
  dirvermessage_ = dirvermessage;
  if (dirvermessage) {
    set_has_dirvermessage();
  } else {
    clear_has_dirvermessage();
