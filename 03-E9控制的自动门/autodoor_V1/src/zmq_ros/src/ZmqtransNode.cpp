...
int main(int argc, char **argv)
{
             ...
             // std::string subadd="tcp://192.168.3.210:5678";
              ...
              std::string pubadd="tcp://192.168.3.62:1234";
              std::string subadd="tcp://192.168.3.62:5678";
                ...
                roszmq.insert_topic(ZMQ_NAME_AUTTODOOR);
		...
		// pub cmd that is from PC
	        ...
	        //sub cmd return or uodate cmd from driverctrol
               ...
               ros::Subscriber sub2 = handel->subscribe("sensor_weather_updataall", 10,  &zmqclient::weather_update_Callback,&roszmq);
